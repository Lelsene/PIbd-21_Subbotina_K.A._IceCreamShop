<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormCustomers.aspx.cs" Inherits="IceCreamShopWeb.FormCustomers" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetList" TypeName="IceCreamShopServiceImplementDataBase.Implementations.CustomerServiceDB"></asp:ObjectDataSource>
        </div>
    </form>
</body>
</html>
