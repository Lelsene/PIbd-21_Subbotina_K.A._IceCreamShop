...
<body>
    ...
    <div>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetList" TypeName="IceCreamShopServiceImplement.Implementations.IngredientServiceList"></asp:ObjectDataSource>
