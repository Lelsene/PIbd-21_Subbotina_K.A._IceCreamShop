<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormMain.aspx.cs" Inherits="IceCreamShopWeb.FormMain" %>
    ...
    <form id="form1" runat="server">
        <asp:Menu ID="Menu" runat="server" BackColor="White" ForeColor="Black" Height="150px">
            <Items>
                <asp:MenuItem Text="Справочники" Value="Справочники">
                    ...
                    <asp:MenuItem Text="Хранилища" Value="Хранилища" NavigateUrl="~/FormStorages.aspx"></asp:MenuItem>
                </asp:MenuItem>
                <asp:MenuItem Text="Пополнить хранилище" Value="Пополнить хранилище" NavigateUrl="~/FormPutOnStorage.aspx"></asp:MenuItem>
                <asp:MenuItem Text="Отчеты" Value="Отчеты">
                    <asp:MenuItem NavigateUrl="~/FormPrice.aspx" Text="Прайс мороженого" Value="Прайс мороженого"></asp:MenuItem>
                    <asp:MenuItem NavigateUrl="~/FormStoragesLoad.aspx" Text="Загруженность хранилищ" Value="Загруженность хранилищ"></asp:MenuItem>
                    <asp:MenuItem NavigateUrl="~/FormCustomerBookings.aspx" Text="Заказы покупателей" Value="Заказы покупателей"></asp:MenuItem>
                </asp:MenuItem>
            </Items>
        </asp:Menu>
        ...
        <asp:GridView ID="dataGridView1" runat="server" AutoGenerateColumns="False" DataSourceID="ObjectDataSource1" ShowHeaderWhenEmpty="True">
            <Columns>
                ...
                <asp:BoundField DataField="IceCreamName" HeaderText="IceCreamName" SortExpression="IceCreamName" />
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DeleteMethod="PayBooking" InsertMethod="CreateBooking" SelectMethod="GetList" TypeName="IceCreamShopServiceImplementDataBase.Implementations.MainServiceDB" UpdateMethod="TakeBookingInWork">
            <DeleteParameters>
